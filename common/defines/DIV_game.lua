...
NDefines.NCountry.MIN_WAR_SUPPORT = -0.1
NDefines.NCountry.MAX_WAR_SUPPORT = 1.0

NDefines.NProduction.MAX_CIV_FACTORIES_PER_LINE = 20 --Vanillia is 15
NDefines.NProduction.BASE_FACTORY_SPEED = 3 --Vanilla is 5
